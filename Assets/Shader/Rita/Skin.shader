    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                //最终漫反射
                #if DirDiffuse_ON
                half3 final_dif = toon_col.rgb * base_col.rgb * _LightColor0.rgb * _DiffuseColor.rgb + add_term * _AddDiffuseColor.rgb;
                #else
                ...
                half spe_fac = pow(saturate(dot(half_dir,normal_world)),_SpecularScale) * ao;
                #if DirSpec_ON
                half3 direct_spe = spe_fac * _LightColor0.rgb * base_col  * _SpecularIntensity * _SpecularColor.rgb;
                #else
