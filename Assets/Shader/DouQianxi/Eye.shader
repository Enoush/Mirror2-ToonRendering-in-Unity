    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half3 normal_world = normalize(mul(normal_tan,t2w));
                ...
                //最终漫反射
                #if DirDiffuse_ON
                half3 final_dif = base_col.rgb * half_lambert * _DiffuseColor.rgb * _LightColor0.rgb;
                #else
                ...
                #if EnvSpec_ON
                env_spe = env_spe * env_lumin * _EnvColor.rgb * base_col.r;
                #else
                env_spe = half3(0,0,0);
                #endif
